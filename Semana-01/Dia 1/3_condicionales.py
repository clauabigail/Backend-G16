...
if sexo == 'Masculino':
    if estatura > 1.30 and estatura<1.49:
        ...
        #si l apersona mide mas de 1.5 o menos de 1.3
        print('No hay ropa')
elif  sexo == 'Femenino':
    #sexo = 'Femenino'
    if estatura > 1.10 and estatura < 1.40:
        ...
        print('No hay ropa')
        # pasa > pass ( no hace nada pero nos permite dejar la condicional vacia)
        pass
...
resultado = 'paque 5 soles' if nacionalidad =='PERUANO' else 'pague 8 soles'
print (resultado)