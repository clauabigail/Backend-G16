...
# Si queremos recorrer la lista de derecha a izq itilizaremos numeros negativos
print(alumnos[-1])

print(alumnos[len(alumnos)-1]) #otra forma, menos eficiente de obtener el ultimo elemento
...
print (ejercicio [2])
# Como puedo devolrver el valor de 5
print(ejercicio[3][1])
...
# Diccionarios
# Ordenado PERO por llaves y modificables
persona = {
    'nombre' : 'Eduardo',
    'edad' : '31',
